        ...
        actions = [
            "<div class='btn-group btn-group-s'>",
                ...
                "<ul class='dropdown-menu'>",
                    "<li><a href='javascript:void(0);' class='start'>Start</a></li>",
                    "<li><a href='javascript:void(0);' class='stop'>Stop</a></li>",
                    "<li><a href='javascript:void(0);' class='restart'>Restart</a></li>",
    ...
    dart.format_assigned_actions = function () {
        var actions = [
            "<div class='btn-group btn-group-s'>",
                ...
                "</button>",
                "<ul class='dropdown-menu'>",
                    "<li><a href='javascript:void(0);' class='unassign'>Unassign</a></li>",
                    "<li role='separator' class='divider'></li>",
                    "<li><a href='javascript:void(0);' class='start'>Start</a></li>",
                    "<li><a href='javascript:void(0);' class='stop'>Stop</a></li>",
                    "<li><a href='javascript:void(0);' class='restart'>Restart</a></li>",
