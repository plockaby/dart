"""
To use this cache buster simply import this module and then make this call when
loading your application:

    from tools.flask.extensions import cache_buster
    cache_buster.init_app(app)

Once initialized, when in production all static files will have their last
modified timestamp appended to them to bust some caches.
"""
